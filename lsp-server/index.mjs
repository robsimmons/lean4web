...
app.use('/verso/view/:id/html-single/-verso-search', (_req, res, next) => {
  res.set('Cache-Control', 'no-transform, max-age=31536000')
  next()
})
app.use('/verso/view/:id/html-single/-verso-data', (_req, res, next) => {
  res.set('Cache-Control', 'no-transform, max-age=31536000')
  next()
})
app.use('/verso/view/:id/html-single/book.css', (_req, res, next) => {
  res.set('Cache-Control', 'no-transform, max-age=31536000')
  next()
})
app.use('/verso/view/:id/html-single/verso-vars.css', (_req, res, next) => {
  res.set('Cache-Control', 'no-transform, max-age=31536000')
  next()
})
